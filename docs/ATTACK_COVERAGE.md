...
| A02 | Фіктивні голоси від власника або issuer | PartiallyMitigated | AutomatedTested | Genuine foreign credentials and frozen API roster/key changes rejected; replacing the trusted roster admits an issuer-created credential. Independent roster provenance and complete role/collusion evidence remain open |
