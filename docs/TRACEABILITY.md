...
| Browser client encryption and inclusion | [V012](https://github.com/Lontkovsky/vidkrytyi-holos/issues/23) | apps/web/src/PollPage.tsx, crypto.ts, tests/e2e/inapp.mjs | artifacts/e2e/report.json, browser-downloaded native archive; same in-app Browser | 10 stages / 22 assertions passed; native 1/1/1 verified offline. Complete keyboard/offline/error matrix remains open |
